 ...
 */
	...
	add_filter ('embed_thumbnail_image_size','mta_embed_thumbnail_image_size');
...
?>
	<div <?php post_class( 'wp-embed' ); ?>>
		...
		<?php
		if( has_excerpt() ){
			echo '<div class="wp-embed-excerpt">'. strip_tags(nl2br(get_the_excerpt())).'</div>';
		} else {
			echo '<div class="wp-embed-excerpt">'. strip_tags(nl2br(mb_substr(get_the_content(), 0, 80))).'...</div>';
		}
		?>
