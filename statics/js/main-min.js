...
//scroll check ====================
n(window).scroll(function(){var e,t=n(window).scrollTop()+.85*i;n(".entry_block_content").children("div.block-group-wrap").each(function(){n(this).offset().top<t&&n(this).addClass("is_active")}),n(".character_essence").each(function(){n(this).offset().top<t&&n(this).addClass("is_active")})})}
...
//lazy image
n("body.use_lazy_load").length&&768<n(window).width()&&n('body.use_lazy_load .entry_block_content img[class*="wp-image-"]').each(function(){if(n(this).hasClass("img-cover-block"))n(this).addClass("cover-figure");else{var e=n(this).attr("src"),t=n(this).attr("srcset");n(this).attr("src","//dummyimage.com/1x1/ffffff/cccccc.gif"),n(this).attr("srcset",e)}}),n(".square_label_block").length&&n(".square_label_block").each(function(){n(this).wrapInner('<div class="square_label_block-inner caption_bkg" />')}),n(".wp-caption-text").length&&n(".wp-caption-text").each(function(){n(this).addClass("square_label_block");var e=n(this).prev("img").attr("title"),t=n(this).prev("img").attr("alt");n(this).wrapInner('<div class="square_label_block-inner caption_bkg" />'),e&&n(this).children(".square_label_block-inner").prepend("<p>"+e+"<br><span>"+t+"</span></p>")});
//keyv-landing ==================
var s=0,o=0,r=n(".site-header-block").height();if(n("#body-wrap").css("padding-top",r+"px"),n(window).width()<769)var r=80;n(".cover-image").each(function(){var e=n(this).offset().top;
//console.log(cvi_height);
});
// key-figure
var t=n(".figure-text").height();n(".figure-text-inner").height(t);var a=jQuery(document).scrollTop();n(window).on("scroll",function(){o=n(this).scrollTop(),
//console.log('winScrollTop>'+winScrollTop+':startPos>'+startPos);
s<=o?(n("#body-wrap").addClass("scroll_down"),n("#body-wrap").removeClass("scroll_up")):o<s-5&&(n("#body-wrap").removeClass("scroll_down"),n("#body-wrap").addClass("scroll_up")),s=o;var a=n(window).scrollTop(),e=n(window).height(),t=100-.05*(a-e),t;
//keyv-figure ==================
if(r<=a?n("#body-wrap, .site-header-block").addClass("hide_header").removeClass("show_header"):n("#body-wrap, .site-header-block").removeClass("hide_header").addClass("show_header"),
//keyv-figure ==================
n(".cover-image").length&&768<n(window).width()&&(n(".cover-image.bkg-fixed").each(function(){var e=n(this).offset().top,t=n(this).height()/8,i=.03*(a-e+t);0<a-e+t?(console.log(i),n(this).children(".text-cover-block").css({top:-1.3*i+20+"%",opacity:.01*(100-7*i)})):n(this).children(".text-cover-block").css({top:"0%",opacity:"1"})}),n(".cover-image.bkg-parallax").each(function(){var e=n(this).offset().top,t=.03*n(this).height(),i=.3*(a-e+t);0<a-e+t?n(this).css({"background-position-y":i+"px"}):n(this).css({"background-position-y":"0px"})})),n("body.page-template-keyv-landing #keyv-figure").length&&768<n(window).width())if(e<=a?t<64?n("#keyv-figure").css({width:"64%","max-width":"64%",flex:"0 0 64%"}):(n("#keyv-figure").css({width:t+"%","max-width":t+"%",flex:"0 0 "+t+"%"}),n("#keyv-figure picture img").css({left:-1*t+"%"})):n("#keyv-figure").css({width:"100%","max-width":"100%",flex:"0 0 100%"}),64<=(t=100-.05*a)){
...
//sp_nav	
var l=navigator.userAgent;/iPhone|iPad|iPod|Android/.test(l)&&n(".tab-nav-unit ul.sub-menu").length&&n(".tab-nav-unit li.menu-item-has-children").each(function(){n(this).removeClass("menu-item-has-children"),n(this).find(".sub-menu").remove()})}),//async
//load
...
$(this).children(".block-item-inner").each(function(){0==$(this).find(".block-vertical-rl").length&&0==$(this).find(".sns-block").length&&$(this).css("min-height",e-50+"px")})}})}$(".entry_block_content header + .cover-image").length&&$(".main-content-wrap").addClass("first-cover"),$("body").removeClass("no-scroll"),$("#content-loader").fadeOut().queue(function(){this.remove()}),$("#body-wrap").removeClass("fader"),0==document.body.scrollTop&&setTimeout(function(){scrollTo(0,1)},1)}),jQuery(function(e){essence_resize_script()}),$(window).on("resize",function(){essence_resize_script()}),
// デバイスの向きが変わったら　=================================================
$(window).on("orientationchange",function(){essence_resize_script()}),function(s,t,i,e){s.fn.doubleTapToGo=function(e){return!!("ontouchstart"in t||navigator.msMaxTouchPoints||navigator.userAgent.toLowerCase().match(/windows phone os 7/i))&&(this.each(function(){var n=!1;s(this).on("click",function(e){var t=s(this);t[0]!=n[0]&&(e.preventDefault(),n=t)}),s(i).on("click touchstart MSPointerDown",function(e){for(var t=!0,i=s(e.target).parents(),a=0;a<i.length;a++)i[a]==n[0]&&(t=!1);t&&(n=!1)})}),this)}}(jQuery,window,document);