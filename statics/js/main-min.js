...
//lazy image
o("body.use_lazy_load").length&&768<o(window).width()&&o('body.use_lazy_load .entry_block_content img[class*="wp-image-"]').each(function(){if(o(this).hasClass("img-cover-block"))o(this).addClass("cover-figure");else{var e=o(this).attr("src"),t=o(this).attr("srcset");o(this).attr("src","//dummyimage.com/1x1/ffffff/cccccc.gif"),o(this).attr("srcset",e)}}),o(".square_label_block").length&&o(".square_label_block").each(function(){o(this).wrapInner('<div class="square_label_block-inner caption_bkg" />')}),o(".wp-caption-text").length&&o(".wp-caption-text").each(function(){o(this).addClass("square_label_block");var e=o(this).prev("img").attr("title"),t=o(this).prev("img").attr("alt");o(this).wrapInner('<div class="square_label_block-inner caption_bkg" />'),o(this).children(".square_label_block-inner").prepend("<p>"+e+"<br><span>"+t+"</span></p>")});
//keyv-landing ==================
