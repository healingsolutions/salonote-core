...
if( e.data.sample_type === 'left_right_unit' ){
	...
	$sample_html += '<img class="alignnone size-full wp-image-79 img-responsive wow fadeIn" src="https://dummyimage.com/600x400/666/fff" alt="" width="600" height="400" /></div>';
	...
	$sample_html += '<div class="lazy btn-item"><p>ボタンが入ります</p></div>';
	$sample_html += '</div>';
...
if( e.data.sample_type === 'fixed_bkg_unit' ){
	$sample_html += '<img class="alignnone size-full wp-image-71 img-responsive wow fadeIn img-cover-block bkg-fixed" src="https://dummyimage.com/1200x650/666/fff" alt="" width="1000" height="667" />';
