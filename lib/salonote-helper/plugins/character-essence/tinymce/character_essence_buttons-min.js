// JavaScript Document
tinymce.create("tinymce.plugins.character_essence",{init:function(u,e){var a=this;a.url=e,
//replace shortcode before editor content set
//エディターコンテンツが読み込まれる前に　ショートコードの置き換え
u.onBeforeSetContent.add(function(e,t){t.content=a._do_spot(t.content)}),
//replace the image back to shortcode on save
//保存時にはショートコードそのものを保存する
u.onPostProcess.add(function(e,t){t.get&&(t.content=a._get_spot(t.content))}),
//キャラクターを追加 =============================================
u.addButton("character_essence",{title:"キャラクターを追加",label:"キャラクターを追加",icon:"icon dashicons-format-status",onclick:function(){
//JSONのURLを格納する
...
//data: {'data': 'data' },
success:function(e){c=e}}),console.log([c]);var i=c[t].images[s],o=e.data.content.replace(/\r\n/g,"<br />");o=(o=o.replace(/(\n|\r)/g,"<br />")).replace(/^(\n|\r)/g,"");var l='<div id="char_id_'+t+'" class="character_essence char_type_'+e.data.type+" char_reverse_"+e.data.reverse+" char_position_"+e.data.position+'"><img src="'+i+'" /><div class="char_content"><p>'+o+"</p></div></div><p>&nbsp;</p>";u.selection.setContent(l)}}//onsubmit
