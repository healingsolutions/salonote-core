...
l.windowManager.open({title:"キャラクター",body:[{type:"listbox",name:"characterid",label:"キャラクター",values:n},{type:"listbox",name:"type",label:"表情",values:[{text:"ノーマル",value:"normal"},{text:"スマイル",value:"smile"},{text:"楽しい",value:"happy"},{text:"決め台詞",value:"seriously"},{text:"悲しい",value:"sad"},{text:"わからない",value:"question"},{text:"怒る",value:"angry"},{text:"おどろく",value:"surprised"},{text:"呆れる",value:"speechless"},{text:"あやまる",value:"sorry"},{text:"寝る",value:"sleep"}]},{type:"listbox",name:"position",label:"キャラクターの位置",values:[{text:"左",value:"left"},{text:"右",value:"right"}]},{type:"checkbox",name:"reverse",label:"反転",classes:"true"},{type:"textbox",name:"content",label:"会話内容",multiline:!0,minWidth:600,minHeight:300}],onsubmit:function(e){l.focus();
//console.log(e.data);
...
//data: {'data': 'data' },
success:function(e){r=e}}),console.log([r]);var s=r[t].images[c],i=e.data.content.replace(/\r\n/g,"<br />");i=(i=i.replace(/(\n|\r)/g,"<br />")).replace(/^(\n|\r)/g,"");var o='<div id="char_id_'+t+'" class="character_essence char_type_'+e.data.type+" char_reverse_"+e.data.reverse+" char_position_"+e.data.position+'"><img src="'+s+'" /><div class="char_content"><p>'+i+"</p></div></div><p>&nbsp;</p>";l.selection.setContent(o)}}//onsubmit
