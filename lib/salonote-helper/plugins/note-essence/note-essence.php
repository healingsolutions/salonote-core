<?php
/*
Plugin Name: note-essence
Plugin URI: 
Description: 文章と写真からコンテンツを生成する
Version: 1.0.0
...
class NOTE_ESSENCE_Class {

	function __construct() {
    
    //function 
    require( NOTE_ESSENCE_PLUGIN_PATH . '/inc/functions.php');
		require( NOTE_ESSENCE_PLUGIN_PATH . '/inc/create_salonote_body.php');
		require( NOTE_ESSENCE_PLUGIN_PATH . '/inc/insert_salonote_note.php');
